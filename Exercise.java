...
public class Exercise {
    ...
    public String toString() {
        ...
        String weightsMessage = totalWeight + " lbs of total weight consisting of " + this.weight.get(Weight.SMALL_5LBS)
                + " x 5 lbs weights, " + this.weight.get(Weight.MEDIUM_10LBS) + " x 10 lbs weights, "
                + this.weight.get(Weight.LARGE_25LBS) + " x 25 lbs weights.";
